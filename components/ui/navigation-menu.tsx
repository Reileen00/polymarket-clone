...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md \
   bg-transparent px-2 py-2 text-sm font-medium text-muted-foreground \
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "group-data-[viewport=false]/navigation-menu:bg-[hsl(213_33%_17%)] \
         group-data-[viewport=false]/navigation-menu:text-white \
         group-data-[viewport=false]/navigation-menu:border-none \
